...
from app.modules.fleet.models import MachineType, MachineRequisition
...
async def test_machine_requisition_pending_approval_display(
    ...
    approver, approver_token = await create_user_with_perms(db, "mr_approver@test.com", ["requisition:approve"], seed_department_a.id)
