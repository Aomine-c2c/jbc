...
ROLES_PERMISSIONS = {
    ...
    "Technician": {
        ...
        "job_card:submit": Scope.DEPARTMENT,
        "job_request:read": Scope.DEPARTMENT,
        "job_request:create": Scope.DEPARTMENT,
        "requisition:read": Scope.DEPARTMENT,
        "requisition:create": Scope.DEPARTMENT,
        "requisition:submit": Scope.DEPARTMENT,
        "requisition:cancel": Scope.DEPARTMENT,
    ...
    "Supervisor": {
        ...
        "requisition:create": Scope.DEPARTMENT,
        "requisition:submit": Scope.DEPARTMENT,
        "requisition:review": Scope.DEPARTMENT,
        "requisition:approve": Scope.DEPARTMENT,
        "requisition:allocate": Scope.DEPARTMENT,
        "requisition:dispatch": Scope.DEPARTMENT,
        "requisition:return": Scope.DEPARTMENT,
        "requisition:close": Scope.DEPARTMENT,
        "requisition:cancel": Scope.DEPARTMENT,
        "machine:view": Scope.GLOBAL,
    ...
    "Department Manager": {
        ...
        "job_card:update": Scope.GLOBAL,
        "job_card:submit": Scope.GLOBAL,
        "job_card:approve": Scope.GLOBAL,
        "job_card:verify": Scope.GLOBAL,
        "job_card:close": Scope.GLOBAL,
        "cross_department_access": Scope.GLOBAL,
        "job_request:read": Scope.GLOBAL,
        "job_request:approve": Scope.GLOBAL,
        "requisition:read": Scope.DEPARTMENT,
        "requisition:create": Scope.DEPARTMENT,
        "requisition:submit": Scope.DEPARTMENT,
        "requisition:review": Scope.DEPARTMENT,
    ...
    "Resource_Coordinator": {
        ...
        "requisition:cancel": Scope.GLOBAL,
    },
    "Safety_Officer": {
        "job_card:read": Scope.GLOBAL,
        "job_card:approve": Scope.GLOBAL,
...
PERMISSION_DESCRIPTIONS = {
    ...
    "job_card:verify": "Verify completed work order",
    ...
    "requisition:cancel": "Cancel requisition",
