...
-----------------  ----------------  --------------------  ------------------------
Database Core      POSTGRESQL        1.42 ms               PASS                    
Redis Broker       Broker/Cache      0.85 ms               PASS                    
Storage Subsystem  Filesystem        140.5 GB (29.6%)      PASS                    
API Gateway        HTTP Gateway      3.15 ms               PASS                    
